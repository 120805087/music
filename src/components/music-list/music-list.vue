...
export default {
    ...
    watch: {
        scrollY(newVal) {
            ...
            this.$refs.layer.style['weblitTransform'] = `translate3d(0,${translateY}px,0)`
            ...
            this.$refs.filter.style['weblitBackdrop-filter'] = `blur(${blur}px)`
            ...
            this.$refs.bgImage.style['weblitTransform'] = `scale(${scale})`
        }
    },
    components: {
        Scroll,
